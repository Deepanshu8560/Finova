...
export const Button = React.forwardRef(({
  ...
  const variants = {
    ...
    secondary: 'bg-surface-card border border-slate-300 text-slate-700 hover:bg-slate-50 focus:ring-slate-300 shadow-sm',
    ghost: 'bg-transparent text-slate-600 hover:text-slate-900 hover:bg-slate-100 focus:ring-slate-200',
    danger: 'bg-rose-50 text-rose-600 hover:bg-rose-100 hover:text-rose-700 border border-rose-200 focus:ring-rose-500',
  };
